...
const Reminder = () => {
  return (
    <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm flex flex-col justify-between min-h-[240px]">
      <div>
        <h3 className="text-lg font-semibold text-gray-800 mb-5">Reminders</h3>
        <div className="mb-0">
